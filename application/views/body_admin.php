      ...
      <table class="table table-hover form1">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="<?php echo site_url('admin/update' . '/' . $row->ID_PKL); ?>">
                <p><button type="button" class="btn btn-warning btn-xs">edit</button></p>
              </a>
              <a href="<?php echo site_url('admin/delete' . '/' . $row->ID_PKL); ?>">
            ...
            <?php } ?>
            <td><a href="<?php echo (site_url('admin/detail_mhs' . '/' . $row->ID_PKL));?>"><?php echo $row->NM_SISWA?></a></td>
