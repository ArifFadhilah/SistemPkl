...
<!-- content -->
<div class="container">
  <h3>DETAIL DATA MAHASISWA PMMB</h3>
  ...
  <a href="<?php echo site_url('home/pdfidcardpmmb' . '/' . $mhs->ID_PKL); ?>" target="_blank" style="text-align:right;"><input type="submit" value="Cetak ID Card" class="btn btn-warning"></a>
  <a href="<?php echo site_url('home/pdfsertifikatpmmb' . '/' . $mhs->ID_PKL); ?>" target="_blank" style="text-align:right;"><input type="submit" value="Cetak Sertifikat" class="btn btn-warning"></a>
  <a href="<?php echo site_url('home/pdfnilaisertifikatpmmb' . '/' . $mhs->ID_PKL); ?>" target="_blank" style="text-align:right;"><input type="submit" value="Cetak Nilai" class="btn btn-warning"></a> 

  <?php 
    /*echo "<br>Untuk mencetak surat keterangan, edit data siswa dengan mengisi kolom keterangan dengan kata 'beres', lalu lihat di sub menu Siswa Selesai PKL/Riset";
