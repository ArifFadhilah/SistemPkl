...
<div class="container">
  ...
  <?php echo form_open('admin/exe_update_selesai');?>
  <div class="row">
    <div class="col-md-6">
      ...
      <table class="table">
        ...
        <tr>
          ...
          <td>:</td>
          <td><input type="text" class="form-control" value="<?php echo $mhs->NO_KETERANGAN?>" name="no_ket"></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
              <select class="form-control" name="jenis_pkl">
                ...
                <?php $temp="OBSERVASI";
                  if($temp!=$mhs->JENIS_PKL)
                  echo "<option value='OBSERVASI'>OBSERVASI</option>";?>
              </select>
          </td>
        </tr>
        <tr>
  ...
  <div class="col-md-6">
    <h4>UPLOAD HASIL SCAN SURAT KETERANGAN(PDF)</h4>
      <?php if (isset($error)): ?>
        ...
        <?php endif; ?>
      <form method="post" action="<?=base_url()?>index.php/admin/uploadpdfketerangan" enctype="multipart/form-data">
