...
<div class="container">
  ...
  <?php echo form_open('admin/exe_updatepmmb  ');?>
  <div class="row">
    <div class="col-md-6">
      <h4>DATA MAHASISWA PMMB</h4>
   ...
   <H4>DATA PEMBIMBING</H4>
      <table class="table">
        ...
        <tr>
          <td>Hasil Magang</td>
          <td>:</td>
          <td><input type="text" class="form-control" value="<?php echo $mhs->HASIL?>" name="hasil"></td>
        </tr>
        <tr>
          <td>VIA</td>
          <td>:</td>
      ...
      <!-- Nilai -->
       ...
       <div class="col-md-6">
        ...
        <tr>
          ...
          <td>:</td>
          <td><input type="number" class="form-control" value="<?php echo $mhs->INTEGRITAS?>" name="integritas" onchange="total()"></td>
        </tr>
        <tr>
          <td>Ketepatan waktu dalam bekerja</td>
          <td>:</td>
          <td><input type="number" class="form-control" value="<?php echo $mhs->KETWAKTU?>" name="ketwaktu" onchange="total()"></td>
        </tr>
        <tr>
          <td>Keahlian berdasarkan bidang ilmu</td>
          <td>:</td>
          <td><input type="number" class="form-control" value="<?php echo $mhs->KEAHLIAN?>" name="keahlian" onchange="total()"></td>        
        </tr>
        <tr>
          <td>Kerjasama dalam tim</td>
          <td>:</td>
          <td><input type="number" class="form-control" value="<?php echo $mhs->KERJASAMA?>" name="kerjasama" onchange="total()"></td>    
        </tr>
      </table>
    </div>
      <div class="col-md-6">
      <table class="table">     
        <tr>
          <td>Komunikasi</td>
          <td>:</td>
          <td><input type="number" class="form-control" value="<?php echo $mhs->KOMUNIKASI?>" name="komunikasi" onchange="total()"></td>   
        </tr>
        <tr>
          <td>Penggunaan teknologi informasi</td>
          <td>:</td>
          <td><input type="number" class="form-control" value="<?php echo $mhs->PENGGUNAAN?>" name="penggunaan" onchange="total()"></td>
        </tr>
        <tr>
          <td>Pengembangan diri</td>
          <td>:</td>
          <td><input type="number" class="form-control" value="<?php echo $mhs->PENGEMBANGAN?>" name="pengembangan" onchange="total()"></td>         
        </tr>
        <tr>
          <td>Total</td>
          <td>:</td>
          <td>     
            <input type="number" class="form-control" value="<?php echo $mhs->TOTAL = ($mhs->INTEGRITAS + $mhs->KETWAKTU + $mhs->KEAHLIAN + $mhs->KERJASAMA + $mhs->KOMUNIKASI + $mhs->PENGEMBANGAN + $mhs->PENGGUNAAN) / 7 ?>" name="total" readonly="readonly"  ></td>      
        </tr>
        </table>
       </div>
       </div>
  ...
  <div class="col-md-6">
    <h4>UPLOAD HASIL SCAN SURAT PERNYATAAN PMMB(PDF)</h4>
      <?php if (isset($error)): ?>
                <div class="alert alert-danger"><?php echo $error; ?></div>
        <?php endif; ?>
        <?php if ($this->session->flashdata('success') == TRUE): ?>
