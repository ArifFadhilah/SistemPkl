...
<div class="container">
  ...
  <?php echo form_open('admin/exe_updatekaur');?>
  <div class="row">
    <div class="col-md-6">
      <input type="hidden" value="<?php echo $kaur->id?>" name="id">
      <table class="table">
        <tr>
          <td>Format</td>
          <td>:</td>
          <td><input type="text" class="form-control" value="<?php echo $kaur->keterangan?>" name="keterangan" required></td>
        </tr>
      </table>
