...
<div class="container">
  ...
  <?php echo form_open('admin/exe_updateurdiklat');?>
  <div class="row">
    <div class="col-md-6">
      <input type="hidden" value="<?php echo $mhs->id_urdiklat?>" name="id_urdiklat">
      <table class="table">
        <tr>
          <td>NP</td>
          <td>:</td>
          <td><input type="text" class="form-control" value="<?php echo $mhs->NP?>" name="np" required></td>
        </tr>
        <tr>
          <td>Nama</td>
          <td>:</td>
          <td><input type="text" class="form-control" value="<?php echo $mhs->AN_KA_URDIKLAT?>" name="an_ka_urdiklat" required></td>
        </tr>
      </table>
