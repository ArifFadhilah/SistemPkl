...
<div class="container">
  ...
  <?php echo form_open('admin/exe_updatejurusan');?>
  <div class="row">
    <div class="col-md-6">
      <input type="hidden" value="<?php echo $mhs->ID_JURUSAN?>" name="id_jurusan">
      <table class="table">
        <tr>
          <td>Nama</td>
          <td>:</td>
          <td><input type="text" class="form-control" value="<?php echo $mhs->NAMA_JURUSAN?>" name="nama_jurusan" required></td>
        </tr>
      </table>
