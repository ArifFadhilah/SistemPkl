...
<div class="container">
  ...
  <div class="col-xs-6 col-sm-3 r">
    ...
    <p style="margin-top:5px;margin-bottom:5px;"><a href="<?=base_url()?>index.php/admin/view_insert"><button class="btn btn-warning">Masukkan Data Siswa/Mahasiswa</button></a></p>
  ...
  <div class="col-xs-6 col-sm-9 bkiri">
    ...
    <div class="row">
      <div class="col-xs-6">
        ...
        <input type="text" placeholder="Berdasarkan Nama Siswa" size="40" name="search">
      ...
      <div class="col-xs-6">
        <form action="<?=base_url()?>index.php/admin/search_pkl_tahun" method="post">
      ...
      <table class="table table-hover form1">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="<?php echo site_url('admin/updateselesai' . '/' . $row->ID_PKL); ?>">
                <p><button type="button" class="btn btn-warning btn-xs">edit</button></p>
              </a>
              <a href="<?php echo site_url('admin/deleteselesai' . '/' . $row->ID_PKL); ?>">
            ...
            <td>
            <?php if($row->pdf_keterangan == ""){?>
              <?php echo $row->NO_KETERANGAN?></td>
            <?php }else{?>
              <a href="<?php echo base_url(); echo $row->pdf_keterangan;?>" target="_blank"><?php echo $row->NO_KETERANGAN?></a></td>
            <?php } ?>
            </td>
            <td><a href="<?php echo (site_url('admin/detail_mhsselesai' . '/' . $row->ID_PKL));?>"><?php echo $row->NM_SISWA?></a></td>
